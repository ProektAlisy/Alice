...
class QuizMessages:
    ...
    RULES_CHOICES: Final = (
        ...
        'Приступаем', иначе скажите sil <[300]> 'Закрой викторину'.
        sil <[300]> Что вы решили? Приступ+аем?
        """.replace(
            "\n",
            " ",
        )
    ...
    ALREADY_IN_PROGRESS: Final = (
        """Вы вернулись. Как здорово! Напоминаю
        правила: Я задаю вопрос и
        предлагаю Вам на выбор три варианта ответа. Для ответа просто назовите
        букву с правильным ответом: А, Бэ или Вэ. Правильный ответ может быть
    ...
    RESUME_REPEAT: Final = (
        """Сейчас вы остановились на вопросе номер
        {current_question_number}.
        Чтобы продолжить викторину скажите 'Продолжим'.
        Чтобы начать викторину заново скажите 'Начать заново'.
        Чтобы завершить викторину скажите 'Закрой викторину'.
        """.replace(
            "\n",
            " ",
        )
