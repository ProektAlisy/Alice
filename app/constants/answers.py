class Answers:
    ...
    TAKE_TRAINING = "Здесь будет информация о прохождении обучения по методичке"
    TAKE_QUIZ = "Здесь будет информация о прохождении викторины"

    LISTEN_TO_LEGISLATION = "Здесь будет информация о выдержках из законодательства"
    ...
    SPECIAL_OFFERS_FOR_VETERINARIES = "Здесь будет информация о компенсации расходов на ветеринарию"
    ...
    INSTRUCTIONS_FOR_LAUNCHING_PODCAST = "Здесь будет информация о запуске подкаста"

    ABOUT_REGIONAL_CLUBS = "Здесь будет информация о региональных клубах"
    ABOUT_SPECIAL_VIEW_FOUNDATION = "Здесь будет информация о фонде Особый взгляд"
    ...
    EXIT_FROM_DISCOUNTS = "Вы вышли из скидок"
    EXIT_FROM_BLIND = "Вы вышли из служб поддержки незрячих"
